 ...
 *
 * Device serial comes from env BRIDGE_DEVICE (default 172.29.225.198:5555).
 */
...
const DEVICE = process.env.BRIDGE_DEVICE || "172.29.225.198:5555";
const ADB = process.platform === "win32" ? "adb.exe" : "adb";

function runAdb(args) {
  return new Promise((resolve, reject) => {
    const p = spawn(ADB, ["-s", DEVICE, ...args], { stdio: ["ignore", "pipe", "pipe"], windowsHide: true });
    let out = "";
