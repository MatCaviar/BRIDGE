...
export function SourceExplorer() {
  ...
  return <section id="源码" className="panel glass">
    <div className="panel-title"><div><p className="eyebrow">02 / SOURCE ATLAS</p><h2>代码结构</h2></div><span className="metric">{declarations.length} declarations</span></div>
    <div className="chips source-summary"><span>{dependencies.length} dependencies</span><span>{sourceEvidence.length} RPC evidence</span></div>
