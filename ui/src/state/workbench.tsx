...
interface WorkbenchState {
  ...
  retryPipeline(): Promise<void>; cancelPipeline(): Promise<void>;
}
...
export function WorkbenchProvider({ children }: PropsWithChildren) {
  ...
  const value = useMemo(() => ({ project, source, sourceEdges, sourceEvidence, sourceFindings, artifacts, events, logs, mcp, pipelineRun, connection, busy, error, setProject, refresh, runStage, retryPipeline, cancelPipeline, setError }), [project, source, sourceEdges, sourceEvidence, sourceFindings, artifacts, events, logs, mcp, pipelineRun, connection, busy, error, refresh, runStage, retryPipeline, cancelPipeline]);
