// imaudio Compose app (com.immotors.imaudio) AIDL contract — verbatim copy of
// imaudio_service_client/com/immotors/aidl/IIMAudioService.aidl, hosted here under
// com.immotors.imaudio because the legacy Car v1 factory imaudio AIDL already occupies
// com.immotors.aidl in this APK. Binder dispatch is by transaction code (declaration
// order), which is identical since the .aidl text is unchanged except the package line.
package com.immotors.imaudio;
import com.immotors.imaudio.IIMAudioCallback;
/**
 * 车载音频服务对外 AIDL 接口。
 *
